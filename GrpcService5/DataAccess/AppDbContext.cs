...
namespace GrpcService5.DataAccess
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) //OnConfiguring metheod and Coonection str    
        {
            ...
            optionsBuilder.UseSqlServer("Server=DESKTOP-SJKQCJ3;Initial Catalog=db5;Integrated Security=True;TrustServerCertificate=True");
        }
