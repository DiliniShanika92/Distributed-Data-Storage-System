...
{
    public class Node4Services : NodeService.NodeServiceBase
    {
        private readonly AppDbContext _dbcontext;
        public Node4Services(AppDbContext dbcontext)
        {
        ...
        {
            request.Content = "Request Node 4";
