...
namespace GrpcService4.DataAccess
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) //OnConfiguring metheod and Coonection str    
        {
            ...
            optionsBuilder.UseSqlServer("Server=DESKTOP-SJKQCJ3;Initial Catalog=db4;Integrated Security=True;TrustServerCertificate=True");
        }
