...
{
    public class Node2Services : NodeService.NodeServiceBase
    {
        private readonly AppDbContext _dbcontext;
        public Node2Services(AppDbContext dbcontext)
        {
       ...
       // "127.0.0.1:7082",
        ...
        {
            request.Content = "Request Node 2";
